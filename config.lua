return {
	bot_api_key = "211738311:AAEaoo0BknfRai8WC8q0mrCrYspOoN6dcpk", --Please add your bot api key here!
	cmd = '^[/!#]',
	allowed_updates = {"message", "edited_message", "callback_query"},
	db = 2, --default redis db: 0
	superadmins = {186280031, 186280031},
	log = {
		chat = -1020129697, --Your log chat, where your bot must be added!
